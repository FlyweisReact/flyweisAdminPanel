                ...
                <tr key={index}>
                  ...
                  <td style={{ display: "flex", gap: "10px" }}>
                    ...
                    <img
                      ...
                      alt=""
                    />
                    <div style={{display : 'flex' , gap : '5px' , border : '1px solid #008000'  , padding : '5px' , borderRadius : '5px'}}>
                      <i class="fa-solid fa-plus" style={{color : '#008000' , fontWeight : 'bold'}}></i> 
                     <div style={{backgroundColor  : '#008000' , height : '20px' , width : '2px' , transform: 'rotate(20deg)'}}></div>
                      <i class="fa-solid fa-minus" style={{color : '#008000'}}></i>
                    </div>
                  </td>
                  <td> {i.Rating} </td>
                  <td>

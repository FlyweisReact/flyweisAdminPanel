          ...
          <Container>
            <Form>
              <Form.Group className="mb-3" controlId="formBasicEmail">
                <Form.Label style={{fontWeight : 'bold'}}>Wallet Amount:</Form.Label>
                <Form.Control
                  type="number"
                  min={0}
              ...
              <Form.Group className="mb-3" controlId="formBasicEmail">
                <Form.Label style={{fontWeight : 'bold'}}>Choose Option (Add or Deduct Money ): </Form.Label>
                <Form.Select aria-label="Default select example">
              ...
              <div style={{display : 'flex' , gap : '10px'}}>
                <button style={{width : '100px' , backgroundColor : '#4099ff' , fontSize : '18px' , color : '#fff' , padding : '10px'}} onClick={() => setWallet(false)}>
                  Submit
                </button>
                <button style={{width : '100px' , backgroundColor : '#f0f0f0' , fontSize : '18px' , color : 'black' , padding : '10px'}} onClick={() => setWallet(false)}>
                  Close
                </button>
              </div>
            </Form>

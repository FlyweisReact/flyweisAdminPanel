  ...
  function MyVerticallyCenteredModal(props) {
    ...
    return (
      ...
      >
        ...
        <Modal.Body>
          <Form>
            <Form.Group onSubmit={postHandler}> 
            ...
            <Form.Group>
              ...
              <Form.Control type="tel" pattern="[0-9]{10}" onChange={(e) => setMobile(e.target.value)}  />
            </Form.Group>
            ...
            <Button variant="outline-success" type='s'>Submit</Button>
          </Form>
        </Modal.Body>

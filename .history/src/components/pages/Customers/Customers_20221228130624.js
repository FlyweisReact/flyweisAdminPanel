...
const Customers = () => {
  ...
  const filter = !query  ? users  : users.filter((i) => i?.name?.toLowerCase().includes(query?.tolo) )
    ...
    <>
      ...
      >
        ...
        <div style={{float : 'right' , color : 'black' }}>
          Search: <input type={'search'} style={{border : '1px solid #bfbfbf' , color : 'black' , padding : '5px'}} />
        </div>

...
const Customers = () => {
  ...
  const filterByDate = async () => {
    try{
        const { data } = await axios.get(`https://u4x75z11l9.execute-api.ap-south-1.amazonaws.com/dev/api/v1/admin/filter?filter=${day}`)
        console.log(data)
    }catch(e) {
      console.log(e)
    }
  ...
  return (
    <>
      ...
      >
        ...
        <select>
          <option onClick={() => filterByDate}>Today</option>

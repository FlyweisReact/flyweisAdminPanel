...
const Saler = () => {
  ...
  return (
    <>
      ...
      />{" "}
      <ViewMember show={view} onHide={() => setView(false)} />{" "}
            ...
            <tbody>
              {filterData.map((i, index) => (
                <tr key={index}>
                  ...
                  <td> 4 <Button style={{backgroundColor : '#4099ff' , borderRadius : '0' , border : '1px solid #4099ff'}}>View</Button> </td>
                  <td> {i.phoneNumber} </td>
                  <td>

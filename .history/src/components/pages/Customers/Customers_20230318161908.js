...
const Customers = () => {
  ...
  const filterByDate2 = async () => {
    try {
      const { data } = await axios.get(
        `https://u4x75z11l9.execute-api.ap-south-1.amazonaws.com/dev/api/v1/admin/filter?startDate=2023-02-15&endDate=2023-03-17`
      );
      setData(data.message);
    } catch (e) {
      console.log(e);
    ...
    <>
      ...
      >
        ...
        <div className="calender">
          ...
          <button onClick={() => filterByDate2()}>Search</button>
        </div>

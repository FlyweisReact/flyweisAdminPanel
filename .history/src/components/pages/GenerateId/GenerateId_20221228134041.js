            ...
            <Form>
              ...
              <Form.Group className="mb-3">
                ...
                <div style={{display : 'flex' , gap : '10px'}}>
                  <button style={{border : '1px solid #bfbfbf' , padding : '10px' }} type='button' onClick={}>Side view</button>
                  <button style={{border : '1px solid #bfbfbf' , padding : '10px' }}>Top view</button>
                  <button style={{border : '1px solid #bfbfbf' , padding : '10px' }}>Front view</button>
                </div>

        ...
        <Modal.Body>
          <Container>
            ...
            <div>
              ...
              <div style={{display : 'flex' , gap : '10px'}}>
                <img src={'https://media.istockphoto.com/id/538162002/photo/dslr-camera-lens-zoom-side-view.jpg?s=170667a&w=0&k=20&c=VWDr4rJgTtdK-n6Pv8isLi-P6oX0kifCyxLAe_TROhI='} alt='' style={{width : '100px'}}/>
                <img src={'https://www.pngitem.com/pimgs/m/106-1063235_nikon-d810-slr-camera-top-view-transparent-png.png'} alt='' style={{width : '100px'}} />
                <img src={'https://thumbs.dreamstime.com/b/film-camera-front-view-22359929.jpg'} alt=''  style={{width : '100px'}}/>
              </div>
              <p
                style={{
                  fontSize: "1.6rem",
              ...
              <div style={{display : 'flex' , gap : '10px'}}>
                <img src={'https://media.istockphoto.com/id/691286862/vector/flat-man-driver-license-plastic-card-template-id-card-vector-illustration.jpg?s=170667a&w=is&k=20&c=jI11Y_DY6udlhE_x8hfddj2tKMhtjLZyKn8Fgv-CqTM='} alt='' style={{width : '100px'}} />
                <img src={'https://support.tradeapp.com/hc/article_attachments/360007169758/Driving_back_EN.png'} alt=''  style={{width : '100px'}}/>
              </div>
              <p
                style={{
                  fontSize: "1.6rem",
              ...
              <div style={{display : 'flex' , gap : '10px'}}>
                <img src={'https://assets-global.website-files.com/5f689f82910c6b4f1ffb855b/613b1f91b195318100f7d27e_aadhar%20card%402x-min.jpg'} alt='' style={{width : '100px'}} />
                <img src={'https://5.imimg.com/data5/YS/PN/XY/SELLER-24419352/pvc-aadhaar-card-500x500.jpg'} alt=''  style={{width : '100px'}}/>
              </div>
              <p
                style={{
                  fontSize: "1.6rem",

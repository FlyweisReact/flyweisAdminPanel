...
import img5 from "../SVG/cityscape-town-svgrepo-com.svg";
          ...
          return (
            ...
            >
              <div className="grid  justify-between grid-cols-4">
                ...
                <div className="flex rounded-full w-10 h-10 sm:w-12 sm:h-12 bg-white justify-center items-center" style={{box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;}}>

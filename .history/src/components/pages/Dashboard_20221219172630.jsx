...
import { FaUserFriends ,FaCity ,FaUserTie ,FaUser ,FaFileInvoice } from "react-icons/fa";
...
const Dashboard = () => {
  ...
  const smallCards = [
    ...
    },
    {
      ...
      number: "150",
      icon: (
        <FaCity className="text-2xl text-[rgb(170,93,225)]" />
      ),
      link: "/city",
    ...
    },
    {
      ...
      number: "150",
      icon: (
        <BsFillPieChartFill className="text-2xl text-[rgb(67,136,232)]" />
      ),
      link: "/graph",
      color : 'rgb(239,76,77)'
    },
    ...
    },
    {
      ...
      number: "150",
      icon: (
        <FaUserTie className="text-2xl text-[rgb(237,77,77)]" />
      ),
      link: "/generateId",
      color : '#36b672'
    },
    {
      ...
      number: "150",
      icon: (
        <FaUser className="text-2xl text-[rgb(241,147,48)]" />
      ),
      link: "/common",
      color : 'rgb(170,93,225)'
    },
    ...
    },
    {
      ...
      number: "150",
      icon: (
        <RiCoupon3Line className="text-2xl text-[rgb(170,93,225)]" />
      ),
    ...
    },
    {
      ...
      number: "150",
      icon: (
        <ImPriceTag className="text-2xl text-[rgb(67,136,232)]" />
      ),
      link: "/pay",
      color : '#36b672'
    },
    ...
    },
    {
      ...
      number: "150",
      icon: (
        <ImImage className="text-2xl text-[rgb(237,77,77)]" />
      ),
      link: "/cat",
      color : 'rgb(239,76,77)'
    ...
    },
    {
      ...
      number: "150",
      icon: (
        <BiHelpCircle className="text-2xl text-[rgb(241,147,48)]" />
      ),
      link: "/terms",
      color : 'rgb(170,93,225)'
    },
    ...
    },
    {
      ...
      number: "150",
      icon: (
        <BiSupport className="text-2xl text-[rgb(170,93,225)]" />
      ),
      link: "/help",
      color : 'rgb(64,153,255)'
    },
   
    {
      ...
      number: "150",
      icon: (
        <BiLogOutCircle className="text-2xl text-[rgb(170,93,225)]" />
      ),
      link: "/",
      color : 'rgb(64,153,255)'
    },
  ...
  return (
    <>
      ...
      <section className="grid md:grid-cols-5 grid-cols-2 gap-y-6 gap-x-4" style={{marginTop : '20%'}}>
        {smallCards.map((card, index) => {
          return (
            <div className="px-3 py-2 space-y-2 shadow-xl flex flex-col  rounded-md" key={index}   onClick={() => navigate(`${card.link}`)} style={{cursor : 'pointer'}}>
            <div style={{
              display : 'flex' 
              ,

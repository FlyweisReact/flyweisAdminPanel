...
const Dashboard = () => {
  ...
  return (
    <>
    <div style={{display : 'flex' , gap : '20px' , marginBottom : '4%'}} >
    <img src={img} alt=""  style={{backgroundColor : '#4099ff' , padding : '8px' , borderRadius : '5px' , boxShadow: 'rgba(0, 0, 0, 0.35) 0px 5px 15px'}} />
    <div>
    <p style={{color : 'black' , fontSize : '18px' , margin : '0' }}>Dashboard</p>
    <span style={{color : 'black' , fontSize : '15px'  , margin : '0' }}>Dashboard</span>
    </div>
    </div>

  ...
  return (
    <>
      ...
      {/* <div
        className={
          hamb
            ? "flex   justify-between  my-1 rounded-sm  p-4 py-3 shadow-md items-center  bg-slate-200 space-x-4"
            : "flex   justify-between my-1 rounded-sm  p-4 py-3 shadow-md items-center  bg-slate-200 space-x-4"
        }
      ...
      >
        ...
        <section className="flex sm:ml-auto justify-end sm:w-full items-center space-x-2  pr-2">
          <figcaption className="tracking-wider pl-1 font-semibold">
            <div className="lg:text-base text-sm text-gray-900  uppercase" style={{color : '#aac0bb'}}>
              Welcome
            </div>
          </figcaption>
        </section>
      ...
      >
        <RiMenu4Line
          ...
          style={{ color: "#aac0bb" }}
        />
        <div style={{ display: "flex", gap: "10px" }} className='items-center space-x-2  pr-2'>
          <p style={{color : '#aac0bb'}} className="lg:text-base text-sm text-gray-900  uppercase">WELCOME</p>
          <FiSettings />
        </div>
      </div>
    </>
